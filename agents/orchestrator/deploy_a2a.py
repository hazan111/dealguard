...
SERVICE_ACCOUNT = "dealguard-orch@" + PROJECT + ".iam.gserviceaccount.com"
...
card = AgentCard(
    ...
    description='DealGuard orchestrator: routes due-diligence documents to specialist risk agents over A2A, verifies citations, links cross-domain findings, maintains the risk register.',
